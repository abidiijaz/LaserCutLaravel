...
<div id="main_content">
    ...
    <div id="header_top" class="header_top">
        <div class="container">
            <div class="hleft">
                <a class="header-brand" href="/admin"><img src="" width="50" style="border-radius:50px;"></a>
                <div class="dropdown">
                    <a href="javascript:void(0)" class="nav-link user_btn"><img class="avatar" src="" alt="" data-toggle="tooltip" data-placement="right" title="User Menu"/></a>
                </div>
            </div>
            <div class="hright">
                <div class="dropdown">
                ...
                <ul class="setting-list list-unstyled mt-1 setting_switch">
                    <li>
                        <label class="custom-switch">
                            ...
                            <input type="checkbox" name="custom-switch-checkbox" class="custom-switch-input btn-darkmode" data-id="" >
                    ...
                    <li>
                        <label class="custom-switch">
                            ...
                            <input type="checkbox" name="custom-switch-checkbox" class="custom-switch-input btn-pageheader" data-id="">
                            <span class="custom-switch-indicator"></span>
                        </label>
                    </li>
                    <li>
                        <label class="custom-switch">
                            ...
                            <input type="checkbox" name="custom-switch-checkbox" class="custom-switch-input btn-min_sidebar" data-id="">
                            <span class="custom-switch-indicator"></span>
                        </label>
                    </li>
                    <li>
                        <label class="custom-switch">
                            ...
                            <input type="checkbox" name="custom-switch-checkbox" class="custom-switch-input btn-sidebar" data-id="">
                            <span class="custom-switch-indicator"></span>
                        </label>
                    </li>
                    <li>
                        <label class="custom-switch">
                            ...
                            <input type="checkbox" name="custom-switch-checkbox" class="custom-switch-input btn-boxshadow" data-id="">
                            <span class="custom-switch-indicator"></span>
                        </label>
                    </li>
    ...
    <div class="user_div">
        ...
        <div class="card-body">
            ...
            <span><span class="text-capitalize">{{Auth::guard('admin')->user()->name}}</span>.{{Auth::guard('admin')->user()->email}}</span>
            <hr>
        </div>
    </div>
    ...
    <div id="left-sidebar" class="sidebar ">
        ...
        <nav id="left-sidebar-nav" class="sidebar-nav">
            <ul class="metismenu">
                ...
                <li class="{{(request()->path()=="admin/dashboard") || (request()->path()=="admin/") || (request()->path()=="admin")?"active":null}}"><a href="/admin/dashboard"><i class="fa fa-dashboard"></i><span>Dashboard</span></a></li>
                <!-- <li class="{{(request()->path()=="admin/manager")?"active":null}}"><a href="/admin/manager"><i class="fa fa-user"></i><span>Product</span></a></li> -->
                <li class="{{(request()->path()=="admin/category") || (request()->path()=="admin/product")?"active":null}}">
                    <a href="javascript:void(0)" class="has-arrow arrow-c"><i class="fa fa-lock"></i><span>Product/Category</span></a>
                    <ul>
                        <li class="{{(request()->path()=="admin/category")?"active":null}}"><a href="/admin/category">Category</a></li>
                        <li class="{{(request()->path()=="admin/product")?"active":null}}"><a class="" href="/admin/product">Product</a></li>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12 col-sm-12 fixed-bottom text-center mb-3">
                            Powered By <a href="https://www.starautomation.net/"><b>AbidIJaz</b></a>
                        </div>
                    </div>
                </div>
            </footer>
