...
@section('content')
<link rel="stylesheet" href="{{ asset('user-end/assets/css/customFieldsSelection.css') }}">
                    ...
                    <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                        ...
                        <div class="product product-7 text-center">
                            <figure class="product-media">
                                ...
                                <a href="product.html">
                                    <img src="user-end/images/pppp_low.png" alt="Product image" class="product-image">
                                </a>
                            ...
                            <div class="product-body">
                                ...
                                <div class="product-nav product-nav-thumbs">
                                    <a href="#" class="active">
                                        <img src="user-end/images/pppp_low.png" alt="product desc">
                                    </a>
                                    <a href="#">
                                        <img src="user-end/images/pppp_low.png" alt="product desc">
                                    </a>
